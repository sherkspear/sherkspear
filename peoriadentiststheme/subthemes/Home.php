<?php exponent_theme_reRoutActionTo("index.php"); ?>
...
<body>
	<div id="doc2">
		...
		<div id="bd">
		    <div id="banner"><?php expTheme::module(array("module"=>"container","view"=>"Default","source"=>"@banner")); ?></div>
			<div id="linkmanager"><?php expTheme::module(array("module"=>"container","view"=>"Default","source"=>"@linkmanager")); ?></div>
			<div id="centercol">
				<?php expTheme::main(); ?>
			</div>
			<div id="rightcol">
			  ...
			  <div id="rightbottom">
    			<?php expTheme::module(array("module"=>"container","view"=>"Default","source"=>"@rightsocial")); ?>
			  </div>
			</div>
